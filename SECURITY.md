...
- GitHub Security Advisory draft: <https://github.com/Nick2bad4u/remark-lint-frontmatter-validation/security/advisories/new>
...
- Keep `remark-lint-frontmatter-validation`, remark, Ajv, and dependencies updated.
- Allow Markdown-controlled remote schema URLs only for trusted content.
- Prefer pinned local schemas for untrusted content and CI.
